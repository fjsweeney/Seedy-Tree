...
function respecBuyables(layer) {
	...
	if (!player[layer].noRespecConfirm && !confirm(tmp[layer].buyables.respecMessage || "Are you sure you want to respec?\r\n\r\nSpent resources will not be returned.\r\nYou will do a " + (tmp[layer].resource ? tmp[layer].resource : layer) + " reset as well!")) return
...
function addTime(diff, layer) {
	...
	time += toNumber(diff)
	player.totalTimePlayed += toNumber(diff)
