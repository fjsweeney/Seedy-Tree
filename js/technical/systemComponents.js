var systemComponents = {
    ...
    'info-tab': {
		...
		<br><a class="link" href="https://jacorb90.me/RNG-Tree/" target="_blank" v-bind:style="{'font-size': '14px'}">Original RNG Tree</a><br>
		
		<br><br>
        Time Played in this seed: {{ formatTime(player.timePlayed) }}<br><br>
		Time Played in The Seedy Tree: {{ formatTime(player.totalTimePlayed) }}<br><br>
        <h3>Hotkeys</h3><br>
    ...
    'options-tab': {
        ...
        <table>
			...
			<tr>
				<td><button class="opt" onclick="newRandomSeedWithWarning()" style="background-color: #a7cf7a;">New Random Seed</button></td>
				<td><button class="opt" onclick="RNGReset()" style="background-color: #a7cf7a;">New Seed</button></td>
				<td><button class="opt" onclick="hardReset()" style="background-color: #ff4b4b;">HARD RESET!!!</button></td>
            </tr>
        </table>`
    },
